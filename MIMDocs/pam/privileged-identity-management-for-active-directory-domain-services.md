...
O PAM (Privileged Access Management) é uma solução que ajuda as organizações a restringirem o acesso privilegiado em um ambiente existente do Active Directory.
